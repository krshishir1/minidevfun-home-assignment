...
export default function HowItWorks() {
  return (
    <section className="w-full bg-neutral-50 py-20 md:py-24">
          ...
          {STEPS.map((step, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute -top-5 -left-5 text-white font-bold h-10 py-1 pt-2 rounded-lg">
                  <Badge className="p-1 px-2 bg-purple-500/90 text-xs">Step {index + 1}</Badge>
                </div>
              </div>
            );
          })}
